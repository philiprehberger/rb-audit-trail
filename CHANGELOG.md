...
### Added
- `Queryable#count_by(field)` aggregation returning event counts grouped by field value

## [0.4.0] - 2026-04-15

### Added
- `Tracker#count(**filters)` returns the number of stored events, optionally filtered with the same keywords as `query`
